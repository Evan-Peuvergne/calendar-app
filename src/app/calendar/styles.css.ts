...
globalStyle(`${options} hr`, {
  display: "block",
  height: 24,
  borderRight: `1px solid ${t.stroke.base}`,
})
...
export const currentTime = style({
  ...
  right: 0,
  borderTop: "1px solid",
  borderImage: `linear-gradient(to right, transparent 0px, ${t.fill.danger} 64px, ${t.fill.danger} calc(100% - 64px), transparent 100%) 1`,
})
