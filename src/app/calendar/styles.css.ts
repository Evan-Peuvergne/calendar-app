...
globalStyle(`${options} hr`, {
  display: "block",
  height: 24,
  borderRight: `1px solid ${tokens.color.stroke.base}`,
})
...
export const currentTime = style({
  ...
  right: 0,
  borderTop: "1px solid",
  borderImage: `linear-gradient(to right, transparent 0px, ${tokens.color.fill.danger} 64px, ${tokens.color.fill.danger} calc(100% - 64px), transparent 100%) 1`,
})
...
globalStyle(`${currentTime} span`, {
  ...
  fontSize: 12,
  fontWeight: 500,
  color: tokens.color.text.contrast,
  background: tokens.color.fill.danger,
  borderRadius: 20,
})
...
export const week = style({
  ...
  selectors: {
    ...
    "&::before": {
      top: 0,
      height: 288,
      background: `linear-gradient(to bottom, ${tokens.color.fill.background}, transparent)`,
    },
    "&::after": {
      bottom: 0,
      height: 48,
      background: `linear-gradient(to top, ${tokens.color.fill.background}, transparent)`,
    },
  },
})
